 ...
 */
final class Version20241119134750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, pack_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, is_annual TINYINT(1) NOT NULL, INDEX IDX_F52993989395C3F3 (customer_id), INDEX IDX_F52993981919B217 (pack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, bay_id INT NOT NULL, usage_id INT NOT NULL, reference VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, INDEX IDX_DCBB0C53DF9BA23B (bay_id), INDEX IDX_DCBB0C532150E69A (usage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', discr VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
